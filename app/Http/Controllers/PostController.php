...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        //page heading
        $title = 'Latest Posts';
        //return bloghome.blade.php template from resources/views folder
        return view('bloghome')->withPosts($posts)->withTitle($title);
    ...
    /*Search Controller
     *Search the post based on the query inserted
     */
